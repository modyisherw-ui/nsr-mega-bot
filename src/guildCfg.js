...
const DEFAULTS = {
  ...
  protection: {
    channelDelete: { enabled: true, threshold: 3, window: 10, action: 'kick', requiredRole: '' },
    nuke: { enabled: true, threshold: 8, window: 20, action: 'kick' },
    ban: { enabled: true, threshold: 3, window: 10, action: 'kick' },
    kick: { enabled: true, threshold: 3, window: 10, action: 'kick' },
