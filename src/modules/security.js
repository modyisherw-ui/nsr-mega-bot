...
const bannedWords = [
  ...
  'شرموط', 'شرموطة', 'شرموته', 'شرموتي', 'شرموطه', 'شرمёт', 'شراميط', 'شرموطه',
  ...
  // ═══════ زنا وزانية ═══════
  'زنا', 'زاني', 'زانية', 'زني', 'زنى', 'زانى', 'زانية', 'itezni',
  ...
  'fashel', 'fashla',
  'ghabi', 'ghabya', 'ghaby',
  // ═══════ اختصارات إنجليزية بذيئة ═══════
  'mf', 'stfu', 'gtfo', 'kys', 'pos',
];
